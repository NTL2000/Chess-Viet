...
public class King extends ChessMan {
    ...
    //    hàm xác định vào đường cùng chưa
...
//        đường ăn của quân tấn công có thể bị chặn lại hay ko
//        di chuyển cản đường (không có tác dụng đối với mã). Điều này cũng giả định rằng
//        di chuyển đống minh không để lộ tướng
...
//        kẻ tấn công không phải là mã và tốt và tướng
        if (!(attacker.isKnight() && attacker.isPawn() && attacker.isKing())) {

//            xác định đường ăn từ trái qua phải, từ dưới lên trên
...
//            các vị trí chặn có thể(là các các vị trí trên đường ăn
...
//           tìm đồng minh để chặn
    ...
    private boolean isAttackerCapturable(Position attackerPosition, ChessBoard chessBoard) {
        ...
        //quân đồng minh có thê tấn công attacker không
    ...
    public boolean isAnyChessManAdvanceable(ChessBoard chessBoard) {
        ...
        // có thể di chuyển bất kỳ quân nào mà không ảnh hưởng đến vua
